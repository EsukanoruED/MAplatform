...
const deltaTones = { up: 'var(--text-success)', down: 'var(--text-danger)', flat: 'var(--text-muted)' };

/** Single-figure metric tile. */
export function StatTile({ label, value, unit, delta, deltaDirection = 'flat', icon, tone = 'plain', footnote, style, ...rest }) {
  const ink = tone === 'ink';
